...
#掩码生成器 从alpha matte生成trimap和segmentation mask
...
class DataGenerator(Dataset):
    def __init__(self, data, phase="train", inp_size=None):
        self.phase = phase
        # 如果提供了 inp_size，则使用它，否则使用默认的 crop_size
        self.crop_size = inp_size if inp_size is not None else CONFIG.data.crop_size
...
if __name__ == '__main__':
    # 训练数据集路径
    train_alpha_dir = "/raid/Data/huangtao/public/matting/vitmatte/alpha/"
    train_fg_dir = "/raid/Data/huangtao/public/matting/vitmatte/fg/"
    train_bg_dir = "/raid/Data/huangtao/public/matting/vitmatte/bg/"
    ...
    # 创建真正的数据集
    train_dataset = DataGenerator(train_data, phase="train")
